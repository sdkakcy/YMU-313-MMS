...
<head>
  ...
  <link href="/backend/css/floatexamples.css" rel="stylesheet" type="text/css" />
...
<body class="nav-md">
      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>MMS Admin Page</span></a>
          </div>
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                <li><a><i class="fa fa-home"></i> Haber <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu" style="display: none">
                    <li><a href="admin/haber/haber-ekle">Haber Ekle</a>
                    </li>
  ...
  <!-- gauge js -->
  <script type="/backend/text/javascript" src="backend/js/gauge/gauge.min.js"></script>
  <script type="/backend/text/javascript" src="backend/js/gauge/gauge_demo.js"></script>
  ...
  <!-- daterangepicker -->
  <script type="/backend/text/javascript" src="backend/js/moment/moment.min.js"></script>
  <script type="/backend/text/javascript" src="backend/js/datepicker/daterangepicker.js"></script>
  <!-- chart js -->
...
/
  ...
  <script type="text/javascript" src="backend/js/flot/jquery.flot.backend/pie.js"></script>
  ...
  <!-- worldmap -->
  <script type="ext/javascript" src="backend/js/maps/jquery-jvectormap-2.0.3.min.js"></script>
  <script type="text/javascript" src="backend/js/maps/gdp-data.js"></script>
  <script type="text/javascript" src="backend/js/maps/jquery-jvectormap-world-mill-en.js"></script>
  <script type="text/javascript" src="backend/js/maps/jquery-jvectormap-us-aea-en.js"></script>
  <!-- pace -->
  ...
  <!-- skycons -->
  <script src="/backend/js/skycons/skycons.min.js"></script>
  <script>
